...
- `cruises.csv` — public CSV extract (9,708 rows)
- `cruises.json` — public JSON extract (9,708 rows)
...
> Unique Domains. *Available .CRUISES One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
